...
typedef NTSTATUS (NTAPI *ZWQUERYSYSTEMINFORMATION)(SYSTEM_INFORMATION_CLASS, PVOID, ULONG, PULONG);
ZWQUERYSYSTEMINFORMATION 	ZwQuerySystemInformation;

typedef NTSTATUS(NTAPI *ZWQUERYINFORMATIONPROCESS)(HANDLE, PROCESSINFOCLASS, PVOID, ULONG, PULONG);
ZWQUERYINFORMATIONPROCESS 	ZwQueryInformationProcess;

typedef NTSTATUS(NTAPI *ZWQUERYINFORMATIONTHREAD)(HANDLE, ULONG, PVOID, ULONG, PULONG);
ZWQUERYINFORMATIONTHREAD 	ZwQueryInformationThread;

typedef NTSTATUS(NTAPI *ZWQUERYATTRIBUTESFILE)(POBJECT_ATTRIBUTES, PFILE_BASIC_INFORMATION);
ZWQUERYATTRIBUTESFILE 		ZwQueryAttributesFile;

typedef NTSTATUS(NTAPI *ZWCREATEPROCESS)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, HANDLE, BOOLEAN, HANDLE, HANDLE, HANDLE);
ZWCREATEPROCESS 			ZwCreateProcess;

typedef NTSTATUS(NTAPI *ZWCREATEPROCESSEX)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, HANDLE, ULONG, HANDLE, HANDLE, HANDLE, BOOLEAN);
ZWCREATEPROCESSEX			ZwCreateProcessEx;

typedef NTSTATUS(NTAPI *ZWCREATEUSERPROCESS)(PHANDLE, PHANDLE, ACCESS_MASK, ACCESS_MASK, POBJECT_ATTRIBUTES, POBJECT_ATTRIBUTES, ULONG, ULONG, PVOID, PVOID, PVOID);
ZWCREATEPROCESSEX			ZwCreateUserProcess;

typedef NTSTATUS(NTAPI *ZWRESUMETHREAD)(HANDLE, PULONG);
ZWRESUMETHREAD				ZwResumeThread;

typedef NTSTATUS(NTAPI *ZWQUERYSECTION)(HANDLE, ULONG, PVOID, ULONG, PULONG);
