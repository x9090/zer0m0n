...
VOID HookSSDT()
{
	...
	/*
	*	Hook implementation in hook_file.c
	*/
	...
	/*
	*	Hook implementation in hook_reg.c
	*/
	...
	/*
	*	Hook implementation in hook_process.c
	*/
	...
	/*
	*	Hook implementation in hook_misc.c
	*/
	Install_Hook(GetSyscallNumber(pImageExportDirectory, "ZwOpenMutant", offsetSyscall), (PVOID)Hooked_NtOpenMutant, (PVOID*)&Orig_NtOpenMutant, pStartSearchAddress, KiServiceTable);
